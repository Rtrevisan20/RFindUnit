unit HDFindUnit.Model.Settings;
...
type
  TCacheSettings = record
    ...
    EnableUnusedUsesHighlight       : Boolean;
  ...
  private
    ...
    function  GetSortUsesByLevel                    : Boolean;
    ...
    function  GetEnableUnusedUsesHighlight          : Boolean;
    ...
    procedure SetSortUsesByLevel                    (const Value: Boolean);
    ...
    procedure SetEnableUnusedUsesHighlight          (const Value: Boolean);
  ...
  public
    ...
    property SortUsesByLevel          : Boolean   read GetSortUsesByLevel           write SetSortUsesByLevel;
    ...
    property EnableUnusedUsesHighlight          : Boolean read GetEnableUnusedUsesHighlight           write SetEnableUnusedUsesHighlight;
...
const
  ...
  CONF_SORT_BY_LEVEL                = 'SORT_BY_LEVEL';
  ...
  CONF_UNUSED_HIGHLIGHT             = 'UNUSED_HIGHLIGHT';
...
begin
  ...
  try
    ...
    Result.SortUsesByLevel                  := Settings.SortUsesByLevel;
    ...
    Result.EnableUnusedUsesHighlight        := Settings.EnableUnusedUsesHighlight;
...
function TSettings.GetEnableUnusedUsesHighlight: Boolean;
begin
  Result := FIni.ReadBool(SETTINGS_SECTION, CONF_UNUSED_HIGHLIGHT, False);
end;
...
function TSettings.GetLanguage: Integer;
begin
  Result := FIni.ReadInteger(SETTINGS_SECTION, CONF_LANGUAGE, 0);
end;
...
function TSettings.GetSortUsesByLevel: Boolean;
begin
  Result := FIni.ReadBool(SETTINGS_SECTION, CONF_SORT_BY_LEVEL, False);
end;
...
procedure TSettings.SetSortUsesByLevel(const Value: Boolean);
begin
  FIni.WriteBool(SETTINGS_SECTION, CONF_SORT_BY_LEVEL, Value);
  FIni.UpdateFile;
end;
...
procedure TSettings.SetLanguage(const Value: Integer);
begin
  FIni.WriteInteger(SETTINGS_SECTION, CONF_LANGUAGE, Value);
  FIni.UpdateFile;
end;
...
procedure TSettings.SetEnableUnusedUsesHighlight(const Value: Boolean);
begin
  FIni.WriteBool(SETTINGS_SECTION, CONF_UNUSED_HIGHLIGHT, Value);
  FIni.UpdateFile;
end;
