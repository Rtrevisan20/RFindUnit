...
uses
  ...
  Xml.XmlIntf,
  RFUGDIPOBJ2, RFUGDIPKerning, RFUGDIPPathText,
  RFUSVGTypes, RFUSVGStyle;
...
{$IFDEF MSWINDOWS}
  Xml.Win.msxmldom,
{$ENDIF}
  RFUGDIPUtils, RFUSVGParse, RFUSVGProperties, RFUSVGColor, RFUSVGPaint, RFUSVGPath, RFUSVGCommon;
