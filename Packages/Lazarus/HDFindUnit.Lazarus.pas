...
uses
  ...
  DelphiAST.Writer, StringBuilderUnit, Log4Pascal, SVG, SVGColor, SVGCommon, 
  SVGPaint, SVGParse, SVGPath, SVGProperties, SVGStyle, SVGTypes, SVGXML, 
  Painter, PainterGdiPlus, PainterLCL, GDIPAPI, GDIPOBJ, GDIPOBJ2, 
  GDIPKerning, GDIPPathText, DirectDraw, RFUNetEncoding, 
